...
//        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.bares) {
            Bar1 fragment = new Bar1();
            ft.replace(android.R.id.content, fragment).commit();
        }
        if (id == R.id.bares) {
            bar2 fragment = new bar2();
            ft.replace(android.R.id.content, fragment).commit();
        }
        if (id == R.id.bares) {
            Bar3 fragment = new Bar3();
            ft.replace(android.R.id.content, fragment).commit();
        }
        switch (id) {
            case R.id.Principal: //este tambien esta en menu.xml
                intent = new Intent(BaresActivity.this, MainActivity.class); //ojo a lo que antepone el this!!!
            ...
            case R.id.sitios: //cerrar es nombre de menu.xml
                intent = new Intent(BaresActivity.this, SitiosActivity.class); //ojo a lo que antepone el this!!!
                intent.putExtra("username", username);
                intent.putExtra("correo", correo);
                startActivity(intent);
                finish();
            ...
            case R.id.hotel: //cerrar es nombre de menu.xml
                intent = new Intent(BaresActivity.this, HotelActivity.class); //ojo a lo que antepone el this!!!
                intent.putExtra("username", username);
                intent.putExtra("correo", correo);
                startActivity(intent);
                finish();
            ...
            case R.id.cerrar: //cerrar es nombre de menu.xml
                intent = new Intent(BaresActivity.this, LoginActivity.class); //ojo a lo que antepone el this!!!
                startActivity(intent);
                finish();
                break;
        }
